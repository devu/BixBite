package org.bixbite.examples.helloflash.model 
{
	...
	public class HelloFlashModel extends Model 
	{
		 ...
		 * This is due to misconception of use MVC paradigm.
         * It's a Model responsibility to describe environment application live in. 
		...
		/**
		 * Is up to Model to decide what to do with this situation.
		 * @param	s
		 */
